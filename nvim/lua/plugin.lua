...
vim.api.nvim_set_hl(0, "TabLine", { fg = colors.fg, bg = colors.gray2 })
vim.api.nvim_set_hl(0, "TabLineSel", { fg = colors.white, bg = colors.gray5 })
vim.api.nvim_set_hl(0, "TabLineSeparator", { fg = colors.gray3, bg = colors.black })

vim.api.nvim_set_hl(0, "SnacksIndent", { fg = colors.gray2 })
vim.api.nvim_set_hl(0, "SnacksIndentScope", { fg = colors.gray2 })
